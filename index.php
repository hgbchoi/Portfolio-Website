...
<div class ="jumbotron">
  <div class = "navigation">
    <nav class="navbar navbar-expand-sm navbar-dark py-0" id = "nav">
          <a class="navbar-brand" href="#"><span class = "bolder-text"><img src = "IMAGES/logo.png">Billy Choi</span></a>
    </div>
    </nav>
    <div class = "text-jumbotron container-fluid is-transparent" id = "jumbo">
      <h1 id = "jumbotexth1" class = "pos-relative is-transparent pad-top-bot">Hi, I'm Billy.</h1>
      <h1 id = "jumbotexth2" class = "pos-relative is-transparent pad-top-bot">Nice to Meet You!</h1>
    </div>
  </div>
  <div class = "jumbo-button-box is-transparent" id = "jumboButtonBox">

          <div class = "jumbo-button is-transparent" id = "jumbo-button-1">
            <button type="button" id = "about-button" class="button-outline button-white">About Me</button>
          </div>
          <div class = "jumbo-button is-transparent" id = "jumbo-button-2">
            <button type="button" id = "skills-button" class="button-outline button-white">Skills</button>
          </div>
          <div class = "jumbo-button is-transparent" id = "jumbo-button-3">
            <button type="button" id = "projects-button" class="button-outline button-white">Projects</button>
          </div>
          <div class = "jumbo-button is-transparent" id = "jumbo-button-4">
            <button type="button" id = "contact-button" class="button-outline button-white">Contact</button>
          </div>
  ...
  <div class = "container-fluid projects-section">
    ...
    <div class = "container flex-container">
      <div class = "pure-g project-flex-box">
        <h1>SC Builds Remastered</h1>
      ...
      <div class = "pure-g project-flex-box">
        <h1>Diet Diary</h1>
          <div class = "project-image">
              <img src = "IMAGES/diet-tracker-screenshot.png">
          </div>
          <div>
